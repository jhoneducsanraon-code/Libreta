...
//deste aca
    ...
    this.createSampleNotes(newUser.id);
    ...
    static createSampleNotes(userId) {

        const sampleNotes = [
            {
                title: 'Mi primer día aquí',
                description: 'Hoy empecé a usar esta aplicación.',
                emotion: 'calma',
                createdAt: new Date().toISOString()
            }
        ];
        ...
        StorageManager.set(
            CONFIG.storageKeys.notes + userId,
            notes
        );
    }
//deste aca
...
class SessionManager {
    ...
    static start(user) {
        ...
        StorageManager.set(
            CONFIG.storageKeys.currentUser,
            {
                userId: user.id,
    ...
    static getCurrent() {
        ...
        const session = StorageManager.get(
            CONFIG.storageKeys.currentUser
        );
